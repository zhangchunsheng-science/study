...
checkpoint0 = ModelCheckpoint("tensorflow_best_model0.hdf5", monitor='val_accuracy', verbose=1, save_best_only=True, mode='auto', period=1, save_weights_only=False)
history0 = model0.fit(X_train, y_train, epochs=5, validation_data=(X_test, y_test), callbacks=[checkpoint0])


best_model = keras.models.load_model("tensorflow_best_model0.hdf5")
